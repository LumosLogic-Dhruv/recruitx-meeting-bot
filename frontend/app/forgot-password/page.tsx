    ...
    <div style={{ display: "flex", alignItems: "center", justifyContent: "center", minHeight: "100vh", background: "radial-gradient(circle at top right, rgba(139,92,246,0.08), transparent 40%), #f8fafc", padding: 20 }}>
      <div style={card}>
        <div style={{ textAlign: "center", marginBottom: 32 }}>
          ...
          <h1 style={{ fontSize: 24, fontWeight: 700, color: "#0f172a", marginBottom: 8 }}>Forgot Password?</h1>
          <p style={{ color: "#64748b", fontSize: 14 }}>Enter your email and we&apos;ll send a reset link.</p>
        </div>

        <form onSubmit={handleSubmit}>
          <div style={{ marginBottom: 20 }}>
            <label style={{ display: "block", fontSize: 12, fontWeight: 600, color: "#64748b", textTransform: "uppercase", letterSpacing: ".06em", marginBottom: 8 }}>Email Address</label>
            <input
